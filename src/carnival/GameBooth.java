...
public class GameBooth {
	...
	public double getCost() {
        ...
        /** 
	 * Returns prizes awarded at each booth.
	 * pre: none
	 * post: Number of each types awarded.
	 */
        public String prizesAwarded(){
            return (p1t +" first prizes have been awarded and "+ p2t +" consolation prizes have been awarded.");
        }
}
